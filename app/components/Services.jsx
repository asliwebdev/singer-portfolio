...
const Services = () => {
  return (
    <div className="bg-gradient flex flex-col lg:flex-row">
      <div className="relative h-[654px] flex-1">
        <Image
          src={video_img}
          alt="services image"
      ...
      <div className="bg-gradient flex flex-1 flex-col justify-center py-6">
        <h2
